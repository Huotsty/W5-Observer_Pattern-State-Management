...
class NewCourseScoreForm extends StatefulWidget {
  const NewCourseScoreForm({super.key, required this.course});
  final Course course; 

  @override
  State<NewCourseScoreForm> createState() => _NewCourseScoreFormState();
}
class _NewCourseScoreFormState extends State<NewCourseScoreForm> {
